				...
				<Accordion expanded={expanded1 === "panel1"} onChange={handleChangePanel1("panel1")}>
					...
					>
						<div>
							<Badge
								color="secondary"
								badgeContent={view === "listener" ? pendingListenerCounts : pendingTellerCounts}
							>
				...
				<Accordion expanded={expanded2 === "panel2"} onChange={handleChangePanel2("panel2")}>
					...
					>
						<div>
							<Badge
								color="secondary"
								badgeContent={view === "listener" ? approveListenerCounts : approveTellerCounts}
							>
				...
				<Accordion expanded={expanded3 === "panel3"} onChange={handleChangePanel3("panel3")}>
					...
					>
						<div>
							<Badge
								color="secondary"
								badgeContent={view === "listener" ? confirmedListenerCounts : confirmedTellerCounts}
							>
				...
				<Accordion expanded={expanded4 === "panel4"} onChange={handleChangePanel4("panel4")}>
					...
					>
						<div>
							<Badge
								color="secondary"
								badgeContent={view === "listener" ? finishedListenerCounts : finishedTellerCounts}
							>
